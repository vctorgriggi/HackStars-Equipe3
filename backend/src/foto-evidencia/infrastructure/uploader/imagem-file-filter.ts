...
// REMOVIDO da whitelist (revisão R1): Textract e Bedrock não aceitam o
// formato — aceitar no upload só adiaria a falha para um 500 na extração.
...
const EXTENSOES_IMAGEM_EVIDENCIA = /\.(jpe?g|png|webp)$/i;
