...
@Module({
  imports: [
    // forwardRef nos dois lados: ConferenciasModule passou a importar este
    // modulo (a extracao le os bytes da evidencia pelo FotosEvidenciaService)
  ...
  exports: [FotosEvidenciaService, RelationalFotoEvidenciaPersistenceModule],
})
